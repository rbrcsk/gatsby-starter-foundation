...
enum FileFieldsEnum {
  ...
  childMarkdownRemark___frontmatter___cta___ctaText = 'childMarkdownRemark.frontmatter.cta.ctaText',
  childMarkdownRemark___frontmatter___cta___ctaLink = 'childMarkdownRemark.frontmatter.cta.ctaLink',
  ...
  childMarkdownRemark___fields___readingTime___text = 'childMarkdownRemark.fields.readingTime.text',
  childMarkdownRemark___fields___readingTime___minutes = 'childMarkdownRemark.fields.readingTime.minutes',
  childMarkdownRemark___fields___readingTime___time = 'childMarkdownRemark.fields.readingTime.time',
  childMarkdownRemark___fields___readingTime___words = 'childMarkdownRemark.fields.readingTime.words',
...
enum MarkdownRemarkFieldsEnum {
  ...
  frontmatter___cta___ctaText = 'frontmatter.cta.ctaText',
  frontmatter___cta___ctaLink = 'frontmatter.cta.ctaLink',
  excerpt = 'excerpt',
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly cta: Maybe<MarkdownRemarkFrontmatterCtaFilterInput>;
};
...
enum SitePageFieldsEnum {
  ...
  context___previous___frontmatter___template = 'context.previous.frontmatter.template',
  ...
  context___next___frontmatter___template = 'context.next.frontmatter.template',
...
type GatsbyNodeBlogPostListQueryVariables = Exact<{ [key: string]: never; }>;


type GatsbyNodeBlogPostListQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id'>
        & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'slug' | 'template' | 'title'>> }
      ) }> } };

type BlogListPageQueryVariables = Exact<{
  skip: Scalars['Int'];
  limit: Scalars['Int'];
}>;
...
type BlogListPageQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        ...
        & { readonly frontmatter: Maybe<(
          ...
          & { readonly featuredImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<(
...
type HomePageBlogPreviewListQueryVariables = Exact<{ [key: string]: never; }>;


type HomePageBlogPreviewListQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<MarkdownRemark, 'id' | 'excerpt'>
        & { readonly frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'date' | 'slug' | 'title'>
          & { readonly featuredImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<(
...
type AboutPageTemplateQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type AboutPageTemplateQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html' | 'excerpt'>
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title'>> }
  )> };

type BlogPostPageTemplateQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type BlogPostPageTemplateQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html' | 'excerpt'>
    & { readonly frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'date' | 'slug' | 'title' | 'description'>
      & { readonly featuredImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<(
            GatsbyImageSharpFluidFragment
            & GatsbyImageSharpFluidLimitPresentationSizeFragment
...
type LayoutQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ siteTitle: SiteSiteMetadata['title'] }> }> };

type ContactPageTemplateQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type ContactPageTemplateQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html' | 'excerpt'>
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title'>> }
...
type SEOQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      ...
      & { defaultTitle: SiteSiteMetadata['title'], defaultDescription: SiteSiteMetadata['description'], siteUrl: SiteSiteMetadata['siteUrl'], defaultImage: SiteSiteMetadata['image'] }
    )> }> };

type IndexPageTemplateQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type IndexPageTemplateQuery = { readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html'>
    & { readonly frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'tagline'>
      & { readonly featuredImage: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluidFragment>, readonly sizes: Maybe<Pick<ImageSharpSizes, 'src'>> }> }>, readonly cta: Maybe<Pick<MarkdownRemarkFrontmatterCta, 'ctaText' | 'ctaLink'>> }
    )> }
  )> };
